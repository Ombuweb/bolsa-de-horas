  ...
  @include('layouts.luna-nav')
      ...
      <x-clients-heading>
        ...
        <div class="header-title">
            <h3 class="m-b-xs">{{$project->name}} > Tasks > new task</h3>
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        <label>Description</label>
                            <textarea class="form-control" rows="3" name="description" placeholder="Describe la tarea"></textarea>
                            @error('description')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                    </div>
                    <div class="form-group col-lg-6">
                        <input type="number"  id="project_id" class="form-control" name="project_id" value="{{$project->id}}" hidden>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8">
                  ...
                  <div class="form-group col-md-8 form-inline">
                        ...
                        <input type="number"  class="form-control" min="0" maxlength="2" placeholder="horas"  name="time_spent_on_hours" required>
                        <label class="m-xxs"> : </label>
                        <input type="number" class="form-control" min="0"  maxlength="2" placeholder="minutos" name="time_spent_on_minutes" required>
                        <label class="m-xxs"> : </label>
                        <input type="number" class="form-control"  min="0" maxlength="2" placeholder="segundos" name="time_spent_on_secs" required>
                        <div class="row">
